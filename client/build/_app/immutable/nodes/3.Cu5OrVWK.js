import{s as Ne,e as i,a,c as s,b as Ke,g as l,d as o,f as _e,h as c,z as Qe,i as Xe,j as n,l as Ze,n as et}from"../chunks/scheduler.DhbVNR2E.js";import{S as tt,i as nt,c as R,a as D,m as J,t as O,b as V,d as F}from"../chunks/index.BswMgjpc.js";import"../chunks/ProgressBar.svelte_svelte_type_style_lang.Cz8GQXdp.js";import{C as Y}from"../chunks/CodeBlock.CEdCFRyr.js";const at=""+new URL("../assets/predictions.Blml3tS9.png",import.meta.url).href;function ot(S){let h,e,u,ke="@oj-sec",K,d,Pe=`Evaluating Large Language Models as future event forecasters - Part
            ...
            using a model we have direct control over.`,de,q,ze=`We can exert direct control over a local LLM using Llama.cpp invoked
            ...
            questions, we get the following distribution of predictions:`,xe,C,Oe,be,U,Ve=`We can see a somewhat untidy normal distribution for the Trump 2024
            ...
            future posts in this series.`,z,Ce,Ye;return v=new Y({props:{language:"plaintext",code:`Predict the likelihood of the following outcome on a scale from 0.00 to 1.00, with 0.00 meaning the event is impossible and 1.00 meaning the event is certain to occur:
...
Predicting the outcome of a future election involves numerous factors including political dynamics, public opinion, candidate performance, and unforeseen events. Given the volatility of politics and the uncertainty surrounding future events, it's challenging to assign a precise likelihood to any specific outcome.`}}),x=new Y({props:{language:"python",code:`from guidance import models, gen
